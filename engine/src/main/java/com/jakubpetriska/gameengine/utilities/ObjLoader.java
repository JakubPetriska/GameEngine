...
/**
 * Creates {@link MeshData} objects from obj file input streams.
 * <p/>
...
public class ObjLoader {
    ...
    /**
     * Creates {@link MeshData} from given input stream.
     *
     * @param assetStream Input stream containing the mesh data. Stream is expected to be in
     *                    obj format.
     * @param renderer    Needed to create the {@link MeshData} object.
     * @return Loaded {@link MeshData} object.
     */
